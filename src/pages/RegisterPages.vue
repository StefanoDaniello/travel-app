    ...
    <div class="register-container">
        ...
        <form @submit.prevent="handleRegister" class="register-form">
            <div class="form-group">
                ...
                <input type="text" id="name" v-model="name" class="form-control" required maxlength="50" />
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" v-model="email" class="form-control" required maxlength="100" />
            </div>
            <div class="form-group">
            ...
            <div class="text-center">
                ...
                <p class="mt-3">Hai un account? <router-link to="/login">Accedi</router-link></p>
            </div>
        </form>
